...
{
    public RestorePref(final Context context) {
        super(context);
        this.init();
    }

    public RestorePref(final Context context, final AttributeSet set) {
        super(context, set);
        this.init();
    }

    public RestorePref(final Context context, final AttributeSet set, final int n) {
        super(context, set, n);
        this.init();
    }
