...
public class grConpickbg extends Superpref {
    ...
    {
        super.onCreate(b);
        addPreferencesFromResource(R.xml.vgrconpickbg);
    }
    ...
    private void b58()
    {
        ...
        if(p.isChecked())
        {
            ...
            p1.setSummary(R.string.conpickbgstartsum);
            p2.setTitle(R.string.endcolor);
            p2.setSummary(R.string.conpickbgendsum);
        ...
        else
        {
            ...
            p2.setSummary(getApplicationContext().getString(R.string.disableoption,"4.20.0"));
            p3.setSummary(getApplicationContext().getString(R.string.disableoption,"4.20.0"));
            p1.setTitle(R.string.conpickbg);
            p1.setSummary(R.string.conpickbgsum);
        }
    }
}
