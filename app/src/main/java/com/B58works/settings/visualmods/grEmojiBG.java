...
public class grEmojiBG extends Superpref {
    ...
    {
        super.onCreate(b);
        addPreferencesFromResource(R.xml.vgremojibg);
    }
    ...
    private void b58()
    {
        ...
        if(p.isChecked())
        {
            ...
            p1.setSummary(R.string.emojibgstartsum);
            p2.setTitle(R.string.endcolor);
            p2.setSummary(R.string.emojibgendsum);
        ...
        else
        {
            ...
            p1.setTitle(R.string.emojibg);
            p1.setSummary(R.string.emojibgsum);
        }
    }
}
